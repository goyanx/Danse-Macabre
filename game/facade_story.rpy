        ...
        return [
            {
                ...
                "content": (
                    ...
                    "Use casual, plain spoken dialogue that reflects the character's immediate state of mind. "
                    "Let them sound tense, hurt, angry, tired, amused, shaken, or relieved as appropriate. "
                    "Short emotional fragments, hesitations, sighs, and blunt admissions are welcome. "
                    "Avoid polished aphorisms, theatrical prose, glib banter, and overly clever lines. "
